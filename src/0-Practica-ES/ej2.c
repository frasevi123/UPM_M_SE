 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Practica 0: ES                                                            *
 * Debe modificarse el programa anterior (ej1.c) para que active el sistema  *
 * de multiplicación de frecuencia del cristal del micro paraconseguir una   *
 * frecuencia Fosc de 79.2576 MHz.                                           *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
