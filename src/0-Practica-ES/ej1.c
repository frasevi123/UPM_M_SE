 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Practica 0: ES                                                            *
 * Debe construirse un programa que configure el reloj del sistema para      *
 * trabajar a la frecuencia del cristal (7,3728 MHz), haciendo que de forma  *
 * indefinida cambie el estado del pin 1 del puerto B.                       *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
