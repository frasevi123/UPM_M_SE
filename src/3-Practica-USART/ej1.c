 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Practica 3: USART                                                         *
 * En el circuito a utilizar, el pin RX de la USART está conectado al pin 6  *
 * del puerto B y el pin TX está conectado al pin 7 del puerto B.            *
 * Debe construirse un programa que escriba de forma indefinida (y de uno en *
 * uno) los caracteres de 0 a 9 (ASCII).                                     *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
